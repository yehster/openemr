    ...
    if(weight_label.length>0)
        {
            ...
            var date_loc=date_text.indexOf(' ');
            var day=date_text.substring(0,date_loc);
            var time=date_text.substring(date_loc+1);
            ...
            var weight_info=$("<span class='weight'>&nbsp;&nbsp;&nbsp;Weight: "+kg+ " kg<span style='font-size:10px' title='"+time+"'>&nbsp;("+day+")</span></span>");
