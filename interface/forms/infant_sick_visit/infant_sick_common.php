...
<script type="text/javascript" src="<?php echo $GLOBALS['webroot'] ?>/interface/forms/infant_sick_visit/js/infant_sick_visit_metadata.js?<?php echo (new DateTime())->getTimestamp();?>"></script>
<script>
