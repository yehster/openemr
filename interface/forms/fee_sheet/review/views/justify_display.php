        ...
        <table>
            ...
            <tbody data-bind="foreach: $data.diagnosis_options">
                <tr data-bind="attr:{class: source, encounter_issue: encounter_issue}">
                    ...
                    <td class="info"><span data-bind="text: description, visible: !edit_mode(), event: {click: start_edit}"></span><input class="description" type="text" data-bind="valueUpdate: 'afterkeydown',value: description, visible: edit_mode(), event: {blur: end_edit, keydown:edit_key},hasfocus: edit_mode()"/></td>
                </tr>
            </tbody>
        </table>
        <div>
