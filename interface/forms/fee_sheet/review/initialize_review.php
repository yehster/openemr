...
<script>
    ...
    var diag_code_types=<?php echo diag_code_types('json',false);?>;  // This is a list of diagnosis code types to present for as options in the justify dialog, for now, only "internal codes" included.
    var global_create=<?php echo (isset($GLOBALS['billing_create_problems']) && $GLOBALS['billing_create_problems']) ? 'true' : 'false';?>;
</script>
