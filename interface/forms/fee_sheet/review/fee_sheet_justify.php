...
if($task=='update')
{
    ...
    if(isset($_REQUEST['create_problems']))
    {
        $create_problems=$_REQUEST['create_problems']=='true';
    }
    else
    {
    ...
    $database->StartTrans();
    create_diags($req_pid,$req_encounter,$diags,$create_problems);
    update_issues($req_pid,$req_encounter,$diags,$create_problems);      
